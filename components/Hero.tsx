          ...
          >
            ...
            >
              <a
                ...
                className="group inline-flex items-center justify-center px-8 py-4 bg-neutral-900 text-white rounded-2xl font-medium hover:bg-neutral-800 transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-0.5"
              >
                Termin vereinbaren
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-neutral-300 text-neutral-900 rounded-2xl font-medium hover:border-neutral-900 hover:bg-neutral-50 transition-all duration-300"
              >
                Mehr erfahren
              </a>
            </motion.div>
