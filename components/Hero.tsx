          ...
          >
            ...
            >
              <a
                ...
                className="group inline-flex items-center justify-center px-8 py-4 bg-neutral-900 text-white rounded-2xl font-medium hover:bg-neutral-800 transition-all duration-500 ease-out hover:shadow-soft-lg hover:-translate-y-1 hover:scale-[1.02]"
              >
                Termin vereinbaren
                <svg className="ml-2 w-5 h-5 transition-transform duration-500 ease-out group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-neutral-300 text-neutral-900 rounded-2xl font-medium hover:border-neutral-900 hover:bg-neutral-50 transition-all duration-500 ease-out hover:scale-[1.02]"
              >
                Mehr erfahren
              </a>
            </motion.div>
