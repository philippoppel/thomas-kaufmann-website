    ...
    <>
          ...
          <div className="flex items-center justify-between h-44 lg:h-56">
            ...
            >
              <Image
                ...
                width={500}
                height={500}
                className="h-40 lg:h-52 w-auto object-contain transition-transform duration-500 ease-out group-hover:scale-105"
                priority
              />
            </a>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <div className="pt-48 px-6 pb-6 h-full flex flex-col">
